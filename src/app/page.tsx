...
function Introduction() {
    return (
        <div className="group gsmContainer self-center sm:self-start rounded-xl w-[25rem] sm:w-[40rem] p-10 ring-[0.3px] min-h-[18rem]">
            <GradOutline />
...
function ProfileImage() {
    return (
        <div className="relative self-center sm:self-end group lg:mr-20">
