...
function MessageBox({ message, blind, index }: MessageBoxProps) {
    ...
    return (
        <motion.div
            ...
            className={`max-w-2xl select-none ${getFlexPos()} z-30 p-6 rounded-lg group gsmContainerLight dark:gsmContainerDark hover:ring-1`}
        >
            <GradOutline />
...
const Messages = [
    {
        message:
            "I'm a final year Data Science student at Mar Athanasius College of Engineering Kothamangalam tredding my way through course work while also dipping my toes in any technology I can find.",
